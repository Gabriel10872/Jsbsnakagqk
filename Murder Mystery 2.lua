...
local Window = OrionLib:MakeWindow({IntroText = "Script Made By GB",IntroIcon = "rbxassetid://7733955511",Name = ("GB HUB • "..GameName.." ✓ Executor "..executor),IntroToggleIcon = "rbxassetid://4335489011",HidePremium = false,SaveConfig = false,IntroEnabled = true,ConfigFolder = "Mm2SHub"})
